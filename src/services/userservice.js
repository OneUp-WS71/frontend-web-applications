...
const getUserData = async (username) => {
  try {
    const response = await axios.get(`    https://oneupmain.zeabur.app/api/oneup/v1/users/username/${username}`);
...
const updateUserData = async (username, userData) => {
  try {
    ...
    const response = await axios.put(`    https://oneupmain.zeabur.app/api/oneup/v1/users/username/${username}`, userData);
...
const getPatients = async (username) => {
  try {
    const response = await axios.get(`https://oneupmain.zeabur.app/api/oneup/v1/users/${username}/patients`);
...
const addPatient = async (userId, patientData) => {
  try {
    ...
    const response = await axios.post(`https://oneupmain.zeabur.app/api/oneup/v1/patients/${userId}`, patientData);
...
const deletePatient = async (patientId) => {
  ...
  try {
    const response = await axios.delete(`https://oneupmain.zeabur.app/api/oneup/v1/patients/${patientId}`);
...
const updatePatient = async (patientId, patientData) => {
  try {
    const response = await axios.put(`https://oneupmain.zeabur.app/api/oneup/v1/patients/${patientId}`, patientData);
    return response.data;
  } catch (error) {
